<template>
	<div class="row justify-content-center">
    	<div class="col-xl-8 col-lg-7 col-md-6">
    		...
    		<card class="card" title="Crear Transporte">
          		<div>
          			<form class="form" @submit.stop.prevent="crearTransporte">
		...
		methods: {
    		...
    		async crearTransporte() {
    			this.loader = true
      			...
      			await this.axios.post(`https://enigmatic-oasis-44862.herokuapp.com/api/auth/transporte/crear`, this.transportes, {
		        	headers:{
		          		"Authorization": `Bearer ${this.token}`
		        	}
		      	})
      			.then(response => {
      				this.loader = false
			        this.loader2 = true
			        this.transportes.razon_social = ''
			        this.transportes.establecimientos = ''
			        this.transportes.telefono = ''
			        this.transportes.correo = ''
			        this.transportes.direccion_principal = ''
			        this.transportes.estado = ''
			        this.transportes.id_municipio = ''
