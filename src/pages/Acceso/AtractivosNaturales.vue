	...
	export default {
      ...
      async eliminar(id) {
        try 
        {
          ...
          if (response.status == 200) {
            this.$swal({
                  icon: 'success',
                  title: 'Atractivo Natural desactivado con éxito!',
                  text: 'El atractivo natural seleccionado fue desactivado con éxito!',
            })
            this.$router.push('/opciones')
          }
        }
      ...
      importar() {
        ...
        .then((response) => {
          this.$swal({
            icon: 'success',
            title: 'Atractivo Natural importado con éxito!',
            text: 'El atractivo natural seleccionado fue importado con éxito!',
          })
        })
        .catch((error) => {
          this.$swal({
