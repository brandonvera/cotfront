	...
	export default {
		...
		methods: {
		    ...
		    async MostrarAlimento() {
		      await this.axios.get(`https://enigmatic-oasis-44862.herokuapp.com/api/auth/alimento/ver/${this.alim_id}`,{
		        headers:{
		          "Authorization": `Bearer ${this.token}`
		        }
		      })
		    ...
		    async editarAlimento() {
		      ...
		      await this.axios.put(`https://enigmatic-oasis-44862.herokuapp.com/api/auth/alimento/modificar/${this.alim_id}`,this.alimentos,
		      {
		        headers:{
		          "Authorization": `Bearer ${this.token}`
		        }
