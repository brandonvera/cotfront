	...
	export default {
		...
		methods: {
		    ...
		    async MostrarNatural() {
		      await this.axios.get(`https://enigmatic-oasis-44862.herokuapp.com/api/auth/natural/ver/${this.nat_id}`,{
		        headers:{
		          "Authorization": `Bearer ${this.token}`
		        }
		      })
		    ...
		    async editarNatural() {
		      ...
		      await this.axios.put(`https://enigmatic-oasis-44862.herokuapp.com/api/auth/natural/modificar/${this.nat_id}`,this.naturales,
		      {
		        headers:{
		          "Authorization": `Bearer ${this.token}`
		        }
